...
const DUMMY_PRODUCTS = [
  ...
  {
    id: 'p4',
    title: 'Sábana Bianco - 160 hilos Percal 100% Algodón',
    subheader: '1 1/2 plaza',
    avatarSrc: logoBianco,
    productDescription: '    •Medidas Disponibles   -Medida Twin: 160x240cm     -Medida Queen: 230x240cm     -Medida King: 270x250cm',
    imgSrc: null,
    productDetail: 'Para colchones de hasta 90 x 1.90 x 30cm Sabana de Arriba: 1.60 m x 2,50 m Sabana Ajustable (para colchón hasta): 90 m x 1,90 m + 30 cm alt. 2 Fundas 50 cm x 70 cm'
